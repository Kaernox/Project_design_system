...
$templateCache.put('templates/akk-tree-item.html','<li ng-class="view.item.childs != undefined ? \'has-child\' : \'\'" class="tree-item d-flex flex-column">\n    <div class="d-flex align-items-center">\n        <i data-ng-if="view.item.childs && view.item.childs.length > 0 && view.item.isShown" data-ng-click="methods.toggle(view.item)" class="material-icons">expand_more</i>\n        <i data-ng-if="view.item.childs && view.item.childs.length > 0 && !view.item.isShown" data-ng-click="methods.toggle(view.item)" class="material-icons">chevron_right</i>\n        <i data-ng-if="!view.item.childs || view.item.childs.length == 0" data-ng-click="methods.toggle(view.item)" class="material-icons text-muted" data-ng-bind="icon != null ? icon : \'bookmark\'"></i>\n\n        <div data-ng-if="!view.item.withoutChoice && view.item.withoutChoice!=\'true\'">\n            <i data-ng-if="view.item.isChecked" data-ng-click="methods.check(view.item)" class="material-icons text-primary">check_box</i>\n            <i data-ng-if="view.item.isPartialyChecked && !view.item.isChecked" data-ng-click="methods.check(view.item)" class="material-icons text-muted">indeterminate_check_box</i>\n            <i data-ng-if="!view.item.isChecked && !view.item.isPartialyChecked" data-ng-click="methods.check(view.item)" class="material-icons text-muted">check_box_outline_blank</i>\n        </div>\n\n        <a href="javascript:;" data-ng-if="view.item.childs && view.item.childs.length > 0" data-ng-click="methods.toggle(view.item)">\n            {{view.options.label ? view.item[view.options.label] : view.item.label}}\n        </a>\n\n        <span data-ng-if="view.item.childs && view.item.childs.length > 0">\n            ({{view.item.childs.length}})\n        </span>\n\n        <span data-ng-if="!view.item.childs || view.item.childs.length == 0">\n            {{view.item.label}}\n        </span>\n    </diV>\n\n    <ul data-ng-if="view.item.childs && view.item.childs.length > 0" data-ng-show="view.item.isShown">\n        <akk-tree-item item="child" data-ng-repeat="child in view.item.childs"></akk-tree-item>\n    </ul>\n</li>');
$templateCache.put('templates/akk-tree.html','<div class="form-group form-tree">\n    <div class="pull-right">\n        <a href="javascript:;" data-ng-click="methods.expandAll()" translate>Tout ouvrir</a>\n        <span> | \n            <a href="javascript:;" data-ng-click="methods.inpandAll()" translate>Tout fermer</a>\n        </span>\n        <span ng-if="multiple"> |\n            <a href="javascript:;" data-ng-click="methods.selectAll()" translate>Tout s\xE9lectionner</a>\n        </span>\n        <span ng-if="multiple"> |\n            <a href="javascript:;" data-ng-click="methods.unselectAll()" translate>Tout d\xE9s\xE9lectionner</a>\n        </span>\n\n        <span ng-if="options.debug && options.debug == true"> |\n            <a href="javascript:;" data-ng-click="methods.debug()" translate>Debug</a>\n        </span>\n    </div>\n    \n    <div class="h4" data-ng-if="view.title">\n        {{view.title}}\n    </div>\n    \n    <ul>\n        <akk-tree-item item="item" data-ng-repeat="item in view.items"></akk-tree-item>\n    </ul>\n    <div ng-if="options.debug && options.debug == true">\n        Model debug\n        <div class="row">\n            <div class="col">\n                <pre>{{view.items| json}}</pre>\n            </div>\n            <div class="col">\n                <pre>{{model| json}}</pre>\n            </div>\n        </div>\n    </div>\n</div>');
